...
#' 
#' Estimation of benchmark doses and benchmark dose lower limit from ordinal
...
#' (2002)
#' 
#' @param object object of class \code{drcOrdinal}
...
#' to use: "delta" (default), "sandwich", "profile" or "bootstrap"
#' 
...
#' 
#' "bootstrap" - BMDL is based on bmd estimates on resampled data sets. The
...
#' 
#' "hierarchical" - If the experiment design is hierarchical (i.e. observations
#' are grouped according to a categorical variable, for instance litter), a
#' special resampling procedure is suggested (Blessinger 2020)
#' 
...
#' 
#' Blessinger, T. D., Euling, S. Y., Wang, L., Hogan, K. A., Cai, C.,
#' Klinefelter, G., Saillenfait, A.M. (2020) \emph{Environment International}
#' \bold{134}
