...
test_that("bmdHetVar on Ryegrass model, def = hybridExc, backgtype = hybridSD", {
  ...
  expect_equal(result$bmrScaled[1,1], unname(object0$curve(result$Results[1, "BMD"])))
  expect_equal(unname(result$interval[1,]), c(1.21029877407248,1.5675419352485))
  ...
  expect_equal(resultParametric$bmrScaled[1,1], unname(object0$curve(resultParametric$Results[1, "BMD"])))
  expect_equal(unname(resultParametric$interval[1,]), c(1.17597981534217,1.63561245267409))
...
test_that("bmdHetVar on Ryegrass model, def = hybridAdd, backgtype = hybridPercentile", {
  ...
  expect_equal(result$bmrScaled[1,1], unname(object0$curve(result$Results[1, "BMD"])))
  expect_equal(unname(result$interval[1,]), c(1.06457123469667,1.42648905128196))
  ...
  expect_equal(resultParametric$bmrScaled[1,1], unname(object0$curve(resultParametric$Results[1, "BMD"])))
  expect_equal(unname(resultParametric$interval[1,]), c(1.03249045631134,1.51113175875138))
...
test_that("bmdHetVar on Ryegrass model, def = hybridAdd, backgtype = hybridSD", {
  ...
  expect_equal(result$bmrScaled[1,1], unname(object0$curve(result$Results[1, "BMD"])))
  expect_equal(unname(result$interval[1,]), c(1.21501660743054,1.57188381181681))
  ...
  expect_equal(resultParametric$bmrScaled[1,1], unname(object0$curve(resultParametric$Results[1, "BMD"])))
  expect_equal(unname(resultParametric$interval[1,]), c(1.18001446789916,1.63934271919724))
...
test_that("bmdHetVar on GiantKelp model, def = hybridExc, backgtype = hybridSD", {
  ...
  expect_equal(result$bmrScaled[1,1], unname(object0$curve(result$Results[1, "BMD"])))
  expect_equal(unname(result$interval[1,]), c(3.34558983991111,21.1813243422884))
  ...
  expect_equal(resultParametric$bmrScaled[1,1], unname(object0$curve(resultParametric$Results[1, "BMD"])))
  expect_equal(unname(resultParametric$interval[1,]), c(5.9069620145796,14.6332619325219))
...
test_that("bmdHetVar on GiantKelp model, def = hybridAdd, backgtype = hybridPercentile", {
  ...
  expect_equal(result$bmrScaled[1,1], unname(object0$curve(result$Results[1, "BMD"])))
  expect_equal(unname(result$interval[1,]), c(1.23069860312066,16.0998877338217))
...
test_that("bmdHetVar on GiantKelp model, def = hybridAdd, backgtype = hybridSD", {
  ...
  expect_equal(result$bmrScaled[1,1], unname(object0$curve(result$Results[1, "BMD"])))
  expect_equal(unname(result$interval[1,]), c(3.4430271147214,21.3097574205103))
