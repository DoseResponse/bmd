...
test_that("bmdHetVarMA on Ryegrass models, def = hybridExc, backgtype = hybridPercentile", {
  ...
  expect_equal(unname(resultAIC$interval[1,]), c(0.91243677103485,1.3064583554297))
  expect_equal(resultAIC$modelWeights, c(0.239817917878516,0.112398486139835,0.00397069684089491,0.643812899140755))
  ...
  expect_equal(unname(resultBIC$interval[1,]), c(0.740131127613234,1.29617185295069))
  expect_equal(resultBIC$modelWeights, c(0.239817917878515,0.112398486139835,0.00397069684089491,0.643812899140755))
  ...
  expect_equal(unname(resultManWeights$interval[1,]), c(0.95908147844657,1.27941263725323))
...
test_that("bmdHetVarMA on Ryegrass models, def = hybridExc, backgtype = hybridSD", {
  ...
  expect_equal(unname(result$interval[1,]), c(1.1544076635982,1.5029430687596))
...
test_that("bmdHetVarMA on Ryegrass models, def = hybridAdd, backgtype = hybridPercentile", {
  ...
  expect_equal(unname(result$interval[1,]), c(0.662428472523196,1.10812296172592))
...
test_that("bmdHetVarMA on Ryegrass models, def = hybridAdd, backgtype = hybridSD", {
  ...
  expect_equal(result$Boot.samples.used, 49)
  expect_equal(unname(result$interval[1,]), c(1.14730351933847,1.51123369350389))
...
test_that("bmdHetVarMA on GiantKelp models, def = hybridExc, backgtype = hybridPercentile", {
  ...
  expect_equal(resultAIC$Boot.samples.used, 48)
  expect_equal(unname(resultAIC$interval[1,]), c(0.970896171135017,17.9687826158524))
  ...
  expect_equal(unname(resultBIC$interval[1,]), c(1.93813846559323,15.0689738215226))
  ...
  expect_equal(resultManWeights$Boot.samples.used, 50)
  expect_equal(unname(resultManWeights$interval[1,]), c(0.509778477285164,16.6029584852476))
...
test_that("bmdHetVarMA on GiantKelp models, def = hybridExc, backgtype = hybridSD", {
  ...
  expect_equal(result$Boot.samples.used, 50)
  expect_equal(unname(result$interval[1,]), c(3.46365031231543,20.4834802123576))
...
test_that("bmdHetVarMA on GiantKelp models, def = hybridAdd, backgtype = hybridPercentile", {
  ...
  expect_equal(result$Boot.samples.used, 50)
  expect_equal(unname(result$interval[1,]), c(1.48403844387169,17.2022294707629))
...
test_that("bmdHetVarMA on GiantKelp models, def = hybridAdd, backgtype = hybridSD", {
  ...
  expect_equal(result$Boot.samples.used, 50)
  expect_equal(unname(result$interval[1,]), c(3.55888343309975,20.6224431910256))
  expect_equal(result$modelWeights, c(0.6,0.4))
})
